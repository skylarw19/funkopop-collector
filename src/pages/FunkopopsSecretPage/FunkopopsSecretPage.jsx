...
const FunkopopsSecretPage = () => {
  return (
    <React.Fragment>
      <h3>This is the Secret Funkopop page!</h3>
      <p>It is located at src/pages/FunkopopSecretPage/FunkopopSecretPage.jsx</p>
...
export default FunkopopsSecretPage;
